...
class Openpos_Core
{
    ...
    public function __construct()
    {
        ...
        // check license
        $this->plugin_info = get_plugin_data(OPENPOS_DIR.'openpos.php');
        //check requirement ....
    ...
    public function formatReceiptSetting($setting,$op_incl_tax_mode= false)
    {
        ...
        $theme_file_path = rtrim(get_stylesheet_directory(),'/').'/openpos/'.$file_name;
        ...
        $gift_theme_file_path = rtrim(get_stylesheet_directory(),'/').'/openpos/'.$_gift_file_name;
