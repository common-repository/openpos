               ...
               <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <form method="GET" id="frm-list-categories">
                        <div>
                            <select multiple="multiple" data-placeholder="<?php esc_attr_e( 'Select categories&hellip;', 'openpos' ); ?>" class="wc-enhanced-select" id="show_categories" name="show_categories[]" style="width: 100%;">
                                <?php
                                $r                 = array();
                                $r['pad_counts']   = 1;
                                $r['hierarchical'] = 1;
